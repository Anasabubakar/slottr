...
export async function handleLinkStep(req: NextApiRequest): Promise<NewCanvas | string> {
  ...
  const input: InputComponent = {
    ...
    label: "Enter your Slottr link",
    placeholder: "https://TODO-your-domain.example/valentinchmara/30min",
    save_state: "unsaved",
    action: {
      type: "submit",
    },
    aria_label: "Enter your Slottr link",
  };
  ...
  const text: TextComponent = {
    type: "text",
    text: "Or choose another Slottr link:",
    style: "muted",
    align: "left",
  };
