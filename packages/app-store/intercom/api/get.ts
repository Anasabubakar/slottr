  ...
  if (req.method === "POST") {
    ...
    if (/^https?:\/\//i.test(url)) {
      try {
        ...
        if (hostname === "TODO-your-domain.example" || hostname.endsWith(".TODO-your-domain.example")) {
          ...
          return res.status(400).json({ message: "URL must be for TODO-your-domain.example or a subdomain of TODO-your-domain.example" });
        }
      } catch {
      ...
      <html>
        ...
        <body>
          ...
          <script type="text/javascript">
            ...
            })(window, "https://TODO-your-domain.example/embed/embed.js", "init");
