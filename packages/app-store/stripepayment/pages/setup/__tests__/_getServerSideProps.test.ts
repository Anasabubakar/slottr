...
vi.mock("@calcom/lib/constants", () => ({
  WEBAPP_URL: "https://TODO-your-domain.example",
}));
...
describe("Stripe Setup Page getServerSideProps", () => {
  ...
  describe("OAuth redirect construction", () => {
    ...
    it("should include correct redirect_uri", async () => {
      ...
      expect(redirect.destination).toContain(
        encodeURIComponent("https://TODO-your-domain.example/api/integrations/stripepayment/callback")
      );
    });
    ...
    it("should include state with default onErrorReturnTo when not provided", async () => {
      ...
      expect(state.onErrorReturnTo).toBe("https://TODO-your-domain.example/apps/installed/payment");
  ...
  describe("Error handling", () => {
    ...
    it("should redirect to error page when getStripeAppKeys fails", async () => {
      ...
      expect(result).toEqual({
        redirect: {
          destination: "https://TODO-your-domain.example/apps/installed/payment?error=stripe_oauth_failed",
          permanent: false,
        },
      });
    });
