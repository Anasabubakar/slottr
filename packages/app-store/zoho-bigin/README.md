...
3. Set the Redirect URL for OAuth `<Slottr URL>/api/integrations/zoho-bigin/callback` replacing Slottr URL with the URI at which your application runs.
...
7. You're good to go. Now you can easily add Zoho Bigin from the [Slottr](https://TODO-your-domain.example) app store.
