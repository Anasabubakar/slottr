...
9. Set the Redirect URI as `<Slottr URL>/api/integrations/webex/callback` replacing [Slottr](https://TODO-your-domain.example) URL with the URI at which your application runs.
