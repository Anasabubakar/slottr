...
const msg = {
  en_us: {
    title: "Welcome to Slottr!",
    content: [
      [
        {
          tag: "text",
          text: "Slottr is an open source scheduling infrastructure.",
        },
      ],
      [
        {
          tag: "text",
          text: 'It allows users to send a unique "TODO-your-domain.example" URL that allows anyone to create bookings on their calendars',
        },
      ],
      [
        {
      ...
      [
        {
          tag: "text",
          text: "1. Visit https://TODO-your-domain.example and sign up for an account.",
        },
      ],
      [
        {
