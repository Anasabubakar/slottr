...
async function postHandler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // used for handle user at bot in feishu chat with TODO-your-domain.example connector bot, see
  ...
  // used for handle user first talk with TODO-your-domain.example connector bot, see
