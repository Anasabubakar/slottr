...
6. Under "Add client" give your client a name, e.g. "Slottr".
7. Set the Redirection URI as `<Slottr URL>/api/integrations/nextcloudtalk/callback` replacing [Slottr](https://TODO-your-domain.example) URL with the URI at which your application runs.
8. Click "Add".
