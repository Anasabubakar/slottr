...
// NOTE: CALCOM_PRIVATE_API_ROUTE previously defaulted to Cal.com's own private license/coupon
// service ("goblin.cal.com"). That service is not this project's infrastructure, so the default
