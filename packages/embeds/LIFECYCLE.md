# Slottr Embed Lifecycle Events

This document details the lifecycle events and states of Slottr embeds, showing the interaction flow between the parent page and the iframe.
...
All messages use the `originator: "CAL"` identifier to distinguish Slottr embed messages:
