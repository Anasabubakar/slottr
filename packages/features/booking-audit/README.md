...
The Booking Audit System tracks all actions and changes related to bookings in Slottr. The architecture is built around two core tables (`AuditActor` and `BookingAudit`) that work together to maintain a complete, immutable audit trail.
...
- **User Actor**: Registered Slottr user
