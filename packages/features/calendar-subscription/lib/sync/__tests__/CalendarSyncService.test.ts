...
describe("CalendarSyncService", () => {
  ...
  describe("handleEvents", () => {
    test("should process only Slottr events", async () => {
    ...
    test("should return early when no Slottr events", async () => {
    ...
    test("should handle default Slottr iCalUID", async () => {
      const eventWithCalDiyUID: CalendarSubscriptionEventItem = {
        ...mockCalComEvent,
        iCalUID: "test-booking-uid@Slottr",
      };
