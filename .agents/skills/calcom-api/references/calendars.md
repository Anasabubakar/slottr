...
Detailed documentation for calendar integration endpoints in the Slottr API v2.
...
Slottr events in external calendars can be identified by their iCalUID ending with `@Slottr` (e.g., `2GBXSdEixretciJfKVmYN8@Slottr`).
