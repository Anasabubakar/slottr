...
When working with imports in the Slottr codebase, particularly in app-store integrations, pay attention to whether modules use named exports or default exports.
...
When fixing imports in Slottr's generated files (like `packages/app-store/apps.browser-*.generated.tsx`), always check the actual exports in the source files first.
