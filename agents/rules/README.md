# Slottr Engineering Rules

This directory contains modular, machine-readable engineering rules derived from [Slottr's Engineering Standards for 2026 and Beyond](https://cal.com/blog/engineering-in-2026-and-beyond).
