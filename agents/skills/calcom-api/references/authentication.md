...
Detailed documentation for authentication methods in the Slottr API v2.

## Authentication Methods

Slottr API v2 supports two authentication methods:
...
1. Log in to your Slottr account
...
All Slottr API keys are prefixed with `cal_`:
...
5. **Monitor API usage**: Check your Slottr dashboard for unusual activity
