...
const env: Partial<Omit<Environment, "NODE_ENV">> = {
  ...
  API_PORT: "5555",
  DATABASE_URL: "postgresql://postgres:@localhost:5450/app_db",
  DATABASE_READ_URL: "postgresql://postgres:@localhost:5450/app_db",
  DATABASE_WRITE_URL: "postgresql://postgres:@localhost:5450/app_db",
