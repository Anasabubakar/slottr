...
```
<Slottr URL>/api/integrations/hubspot/callback
```

Replace `<Slottr URL>` with the URL where your application is hosted.
...
10. **Complete HubSpot Integration** - You're all set! Any booking in Slottr will now be created as a meeting in HubSpot for your contacts.
